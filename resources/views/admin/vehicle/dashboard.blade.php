          ...
          <div class="col-md-12 col-sm-5 col-xs-12">
            <nav class="navbar vehicle-dashboard-navbar-tabs">
              <ul class="nav nav-tabs nav-justified vehicle-dashboard-navbar-tabs" id="dashboard-navbar-tabs-collapse">
                <li class="{{ (($errors->hasBag('reservations') or count($errors->getBags()) == 0) and (empty(session()->get('status')) or !empty(session()->get('status')['info']))) ? 'active' : '' }}">
                  <a data-toggle="tab" class="btn" href="#home_tab"><span class="glyphicon glyphicon-info-sign"></span>&nbsp;&nbsp;Home</a>
                </li>
            ...
            <div class="container-fluid">
              <div class="row">
                <div class="tab-content vehicle-dashboard-tab-content">
                  <div id="home_tab" class="tab-pane fade{{ (($errors->hasBag('reservations') or count($errors->getBags()) == 0) and (empty(session()->get('status')) or !empty(session()->get('status')['info']))) ? ' in active' : '' }}">
                      ...
                      <div class="row">
                        <div class="col-md-4">
                          ...
                          {{--<p style="font-size: 16px;">--}}
                            ...
                            {{--<b>Date added:</b> {{ date('jS M Y H:ia', strtotime($vehicle->created_at)) }} <br>--}}
                            {{--<b>Last changed:</b> {{ date('jS M Y H:ia', strtotime($vehicle->updated_at))  }}--}}
                          {{--</p>--}}
                        </div>
                        <div class="col-md-5">
                          <h3>Vehicle Statistics</h3>
