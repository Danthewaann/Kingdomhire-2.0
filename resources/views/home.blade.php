...
<div class="row">
	<div class="col-md-4">
		<h3>What is Kingdom Car Hire?</h3>
		<p>Kingdom Car Hire is a self-employed, one-man business owned and ran by proprietor Keith Black. The business specialises in vehicle hire and repair.</p>
		<p>Keith's experience spans over 40 years of working in the motor industry, so you can expect high quality service.</p>
		<p>Kingdom Car Hire is located and based just outside Markethill, Co. Armagh. Exact directions can be found on our Contact page.</p>
		<div id="table"></div>
	</div>
	<div class="col-md-4">
		<h3>What we provide to you</h3>
	...
	<div class="col-md-4">
	  <h3>Opening hours &amp; reservations</h3>
