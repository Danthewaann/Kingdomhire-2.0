  ...
  <div class="col-lg-9 col-sm-9">
    <div class="tab-content">
      @if($vehiclesWithType->isNotEmpty())
        <div id="all" class="tab-pane fade in active scene_element scene_element--fadeinup">
          <div class="row">
        ...
        @foreach($vehicleTypes as $vehicleType)
          <div id="{{ str_replace(" ", "-", $vehicleType->name) }}" class="tab-pane fade scene_element scene_element--fadeinup">
            <div class="row">
      ...
      @endif
      @if($vehiclesWithNoType->isNotEmpty())
        <div id="na" class="tab-pane fade{{ $vehiclesWithType->isEmpty() ? ' in active' : '' }} scene_element scene_element--fadeinup">
          <div class="row">
