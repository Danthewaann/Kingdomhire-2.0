    ...
    <div class="row">
      <div class="col-md-5 col-sm-12 col-xs-12">
        <div class="panel panel-default">
          <div class="panel-heading panel-title-text"><h3>Edit active hire</h3></div>
              ...
              <div class="form-row">
                ...
                <div class="form-group{{ $errors->has('end_date') ? ' has-error' : '' }} col-md-12">
                  <div class="form-row">
                    ...
                    {{ Form::text('end_date', $hire->end_date, array('class' => 'form-control datepicker', 'autocomplete' => 'off')) }}
