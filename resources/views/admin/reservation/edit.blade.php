...
<div class="row">
  ...
  <div class="col-md-3 col-sm-5 col-xs-12">
    <div class="panel panel-default">
      <div class="panel-heading panel-title-text"><h3>Edit Reservation Form</h3></div>
          ...
          <div class="form-row">
            ...
            <div class="form-group{{ $errors->has('start_date') ? ' has-error' : '' }} col-md-12">
              <div class="form-row">
                ...
                {{ Form::text('start_date', $reservation->start_date, array('class' => 'form-control datepicker', 'style' => 'max-width: 300px;', 'autocomplete' => 'off')) }}
            ...
            <div class="form-group{{ $errors->has('end_date') ? ' has-error' : '' }} col-md-12">
              <div class="form-row">
                ...
                {{ Form::text('end_date', $reservation->end_date, array('class' => 'form-control datepicker', 'style' => 'max-width: 300px;', 'autocomplete' => 'off')) }}
