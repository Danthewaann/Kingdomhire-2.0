<div class="modal fade" id="vehicle-type-{{ $vehicleType->id }}-delete" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      {{ Form::open(['route' => ['admin.vehicle-types.destroy', $vehicleType->name],
      ...
      <div class="modal-footer">
        ...
        <button type="submit" form="vehicle-type-{{ $vehicleType->id }}-delete-form" class="btn btn-primary"><span class="glyphicon glyphicon-ok"></span>&nbsp;&nbsp;Yes</button>
      </div>
    </div>
  </div>
</div>