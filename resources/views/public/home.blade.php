	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-8">
				...
				<p class="paragraph">Kingdomhire is located and based just outside <b>Markethill, Co. Armagh.</b> Exact directions can be found on our <b><a class="text-link" href="{{ route('public.contact') }}">Contact Us</a></b> page.
