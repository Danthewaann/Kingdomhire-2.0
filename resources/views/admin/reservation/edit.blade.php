    ...
    <div class="row">
      <div class="col-md-5 col-sm-12 col-xs-12">
        <div class="panel panel-default">
          <div class="panel-heading panel-title-text"><h3>Edit reservation</h3></div>
              ...
              <div class="form-row">
                <div class="form-group col-md-12">
                  <div class="form-row">
                    ...
                    <input id="vehicle" class="form-control" type="text" value="{{ $vehicle->name() }}" disabled/>
                  </div>
                </div>
                <div class="form-group{{ $errors->has('start_date') ? ' has-error' : '' }} col-md-12">
                  <div class="form-row">
                    <label for="start_date">Start Date</label>
                    {{ Form::text('start_date', $reservation->start_date, array('class' => 'form-control datepicker', 'autocomplete' => 'off')) }}
                ...
                <div class="form-group{{ $errors->has('end_date') ? ' has-error' : '' }} col-md-12">
                  <div class="form-row">
                    ...
                    {{ Form::text('end_date', $reservation->end_date, array('class' => 'form-control datepicker', 'autocomplete' => 'off')) }}
